  ...
  return (
    <>
      <main className='bg-stone-900 text-white overflow-hidden overflow-y-scroll relative'>
            <section className='relative flex flex-wrap justify-around w-100vw max-w-75rem mx-0 my-auto overflow-hidden  h-full '>
              <br/><br/>
                <div className='h-full w-100vw p-8 text-3xl flex flex-col justify-center   left-0 '>
                
                    <span className='flex  mt-16 flex-row justify-between items-center w-full text-gradient'>Sometimes,</span><span className=' font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'>you just need to see it.</span><br className='sm:block hidden' />


                    <img className=' top-10  object-cover text-center max-w-40 max-h-40' src={logo} alt="Logo" /><br/>
                ...
                <Lottie className='flex-1 mt-8 realtive overflow-hidden' animationData={animationData} />
                </div>
              </section>
              <section className='overflow-hidden w-100vw max-w-65rem flex flex-col justify-center align-text mx-0 my-auto text-center items-center ' >
                    <span className='font-bold text-5xl mb-4 pt-12  '>Features of this site</span><br/>
              ...
              <section className='overflow-hidden w-100vw max-w-65rem flex flex-col justify-center align-text mx-0 my-auto text-center items-center ' >
                    <span className='font-bold text-5xl mb-6 pt-12  '>About of this site</span><br/>
                    <span className='font-normal text-lg px-0 py-8 max-w-4xl '>JS lab is skilled and passionate about HTML,CSS,JAVASCRIPT and have many thing that you can learn about these three</span>
                    <div className='m-6  w-3/4 text-left '>
                        <div className='flex m-1 px-6 py-8 rounded-lg  bg-zinc-800'>
                            ...
                            <div className=' '>
                                ...
                                <p className='text-sm '>HTML stands for Hyper Text Markup Language. HTML is the standard markup language for creating Web pages. HTML describes the structure of a Web page.</p>
                            </div>
                        </div>
                    </div>
                    <div className='m-6  w-3/4 text-left '>
                    <div className='  flex m-1 px-6 py-8 rounded-lg  bg-zinc-800'>
                            ...
                            <div className=' '>
                                ...
                                <p className='text-sm '>CSS (Cascading Style Sheets) is used to style and layout web pages — for example, to alter the font, color, size, and spacing of your content, split it into multiple columns, or add animations and other decorative features.</p>
                            </div>
                        </div>
                    </div>
                    <div className='m-6  w-3/4 text-left '>
                    <div className='  flex m-1 px-6 py-8 rounded-lg  bg-zinc-800'>
                            ...
                            <div className=' '>
                                ...
                                <p className='text-sm '>JavaScript is a scripting language that enables you to create dynamically updating content, control multimedia, animate images, and pretty much everything else.</p>
                            </div>
                        </div>
                    </div>
              </section>
      ...
      return (
        <Card sx={{ maxWidth: 345 }}>
          ...
          <Link
                    to="/notes"
                    className={({ isActive }) =>
                      `${isActive ? 'text-blue-500' : 'text-orange-500-700'} text-gray-300 hover:bg-orange-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium`
                  ...
                  <Link
                    to="/Test skills"
                    className={({ isActive }) =>
                      `${isActive ? 'text-blue-500' : 'text-grey-700'} text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium`
